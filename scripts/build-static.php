...
foreach ($pages as $source => $target) {
    ...
    $html = str_replace(
        ['href="sd.php', 'href="smp.php', 'href="smk.php', 'href="tk-paud.php', 'href="rosari.php', 'href="kontak.php'],
        ['href="sd.html', 'href="smp.html', 'href="smk.html', 'href="tk-paud.html', 'href="rosari.html', 'href="kontak.html'],
        $html
    );

        ...
        <div class="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1.2fr_0.8fr_0.8fr] lg:px-8">
            <div>
                <div class="flex items-center gap-3">
                    <span class="grid h-11 w-11 place-items-center rounded-lg bg-orange-600 text-base font-bold text-white">YC</span>
                    <div>
            ...
            <div>
                ...
                <div class="mt-4 grid gap-2 text-sm text-slate-600">
                    ...
                    <a class="transition hover:text-orange-700" href="mailto:<?= e($data['foundation']['email']); ?>"><?= e($data['foundation']['email']); ?></a>
                    <a class="transition hover:text-orange-700" href="<?= e(whatsapp_url($data['foundation']['phone'], 'Halo Yayasan Cendekia, saya ingin bertanya.')); ?>" target="_blank" rel="noopener">WhatsApp Yayasan</a>
                </div>
            </div>
        </div>

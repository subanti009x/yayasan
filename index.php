...
<main>
    ...
    <section class="bg-slate-50 py-16 sm:py-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-10 max-w-3xl">
                <p class="text-sm font-bold uppercase tracking-wide text-teal-700">Kegiatan Sekolah</p>
    ...
    <section class="bg-white py-16 sm:py-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mb-10 max-w-3xl">
                <p class="text-sm font-bold uppercase tracking-wide text-teal-700">Alur Pendaftaran</p>
            ...
            <div class="grid gap-4 md:grid-cols-4">
                <div class="rounded-lg border border-slate-200 bg-slate-50 p-5">
                    <p class="text-sm font-bold text-teal-700">01</p>
                ...
                <div class="rounded-lg border border-slate-200 bg-slate-50 p-5">
                    <p class="text-sm font-bold text-teal-700">02</p>
                ...
                <div class="rounded-lg border border-slate-200 bg-slate-50 p-5">
                    <p class="text-sm font-bold text-teal-700">03</p>
                ...
                <div class="rounded-lg border border-slate-200 bg-slate-50 p-5">
                    <p class="text-sm font-bold text-teal-700">04</p>
